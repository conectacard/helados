...
const CONFIG = {
    ...
    youtubeUrl: "https://www.youtube.com/watch?v=U7tjYYEuVFE",
    textos: {
        cat1: { t: "QUIÉNES SOMOS", c: "En nuestras sucursales servimos los helados más cremosos, paletas artesanales de fruta natural, malteadas perfectas y refrescantes nieves bien frías. Además, contamos con servicio a domicilio con empaque térmico para que disfrutes en casa, o puedes pedir directo en el mostrador para llevar" },
        cat2: { t: "ESTO NOS HACE DIFERENTES", c: "Nos distinguen nuestros helados de receta secreta y paletas artesanales hechas con fruta 100% natural. Sin conservadores, con la textura más cremosa y preparados con pasión para refrescar tus mejores momentos." },
        cat3: { t: "CLIENTES FELICES", c: "Nuestros clientes, tanto locales como los que nos visitan de fuera para refrescar sus tardes, nos eligen y recomiendan por nuestra gran frescura, servicio, variedad de sabores y calidad artesanal, reconociendo nuestra cremosa tradición en cada una de nuestras heladerías" }
    },
    sucursales: {
...
function renderGallery(cat) {
    ...
    if (cat === 'cat3' || cat === 'cat2') {
        ...
        if (cat === 'cat3') {
            ...
            videoContainer.innerHTML = `
                <a href="https://www.youtube.com/shorts/jHPUYuDuM5o" target="_blank" style="background: #b00; color: #fff; padding: 12px 25px; border-radius: 12px; text-decoration: none; font-weight: 900; font-size: 0.9rem;">
